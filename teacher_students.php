...
<nav>
    ...
    <ul>
        <div style="color:#fff; font-size:17px;">👨‍🏫 <?= $enseignant_name ?></div><br>
...
<div class="container">
    ...
    <div class="page-header">
        <h1>👦 My Students</h1>
        <p>List of students approved by the administration, ordered by section.</p>
    </div>
    ...
    <?php if (empty($classes)): ?>
        <div class="empty-msg">
            ...
            <h3>No approved students at the moment</h3>
            <p>Students will appear here as soon as the administration approves their profiles.</p>
        </div>
    <?php else: ?>
        ...
        <div class="classe-section" data-classe="<?= htmlspecialchars($classe_nom) ?>">
            ...
            <div class="classe-header">
                ...
                <h2>Class: <?= htmlspecialchars($classe_nom) ?></h2>
                <span class="count-badge"><?= count($eleves) ?> Student(s)</span>
            </div>
